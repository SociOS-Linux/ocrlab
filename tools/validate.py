...
EXPECTED_SERVICE_ID = "ocrlab.holmes.ocr-pilot"
EXPECTED_FUNCTION = "ocr"
...
def main() -> int:
    ...
    if manifest.get("function") != EXPECTED_FUNCTION:
        return fail("manifest function must be ocr")
    service = manifest.get("service", {})
    if service.get("id") != EXPECTED_SERVICE_ID:
        return fail("manifest service.id mismatch")
    if service.get("ownerRepository") != "SociOS-Linux/ocrlab":
    ...
    print("OK: ocrlab manifest and fixtures validated")
    return 0
